...
class ZhihuTestSpider(scrapy.Spider):
    ...
    phone = '15221204645'  # 手机号
    password = 'cm4615281///'  # 密码
    ...
    def parse_question(self, response):
        ...
        if "QuestionHeader-title" in response.text:
            ...
            item_loader.add_xpath(
                "content", "//*[@class='QuestionHeader-detail']/div/div/span/text()")
    ...
    def start_requests(self):
        ...
        time.sleep(10)
        # browser.find_element_by_css_selector(".SignFlow-accountInput.Input-wrapper input").send_keys("15221204645")
        # # browser.find_element_by_css_selector(".SignFlow-passwordInput.Input-wrapper input").send_keys("cm4615281///")
        # browser.find_element_by_css_selector(".SignFlow-password Input").send_keys("cm4615281///")
        ...
        # print(Cookies)
        # # Cookies.save(filename = "../../cookies/zhihu/cookie.txt")
        # cookie_dict = {}
        # import pickle
        # for cookie in Cookies:
        #     # 写入文件
        #     f = open('Z:\code_python\ArticleSpider\cookies\zhihu\\'+ cookie['name'] + '.zhihu', )
...
class ZhihuTestSpider(scrapy.Spider):
    ...
    def login(self, response):
        ...
        fp = open('G:\迅雷下载\zhihu_spider-master\zhihu_spider-master\zhihu.js')
        js = fp.read()
        fp.close()
        ctx = execjs.compile(js)
        signature = ctx.call('getSignature', timestamp)  # python调用js
        params = {
